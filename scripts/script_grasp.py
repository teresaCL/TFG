...
cabecera_resumen_dataset = '||' + str("dataset").rjust(15) + ' |' + str("score").rjust(15) + ' |' + str("n_iter").rjust(15) + ' |' + str("n_iter_ls").rjust(15) + ' |' + str("time(s)").rjust(15) + ' |' + str("% ended no improv").rjust(15) + ' ||\n'
...
cabecera_resumen_mismas_restr = '||' + str("dataset").rjust(15) + ' |' + str("restricciones").rjust(15) + ' |' + str("score").rjust(15) + ' |' + str("n_iter").rjust(15) + ' |' + str("n_iter_ls").rjust(15) + ' |' + str("time(s)").rjust(15) + ' |' + str("% ended no improv").rjust(15) + ' ||\n'
...
for data, k in datasets:
    ...
    for file in archivos_restricciones:
        ...
        file_resultados = f"./Results/{date}/{data}/{file.split('/')[-1].split('.')[0]}/{file.split('/')[-1].split('.')[0]}.pkl"
        ...
        list_no_improve.append(results["ended_no_improvement"])
        ...
        if file.endswith("4.json"):
            ...
            media_mismas_restr_no_improv = (sum(list_no_improve[-5:])/5) * 100

            resumen_mismas_restr = '||' + str(f"{data}").rjust(15) + ' |' + str(f"{file.split('/')[-1].split('.')[0][:-2]}").rjust(15) + ' |' + str(round(media_mismas_restr_score,3)).rjust(15) + ' |' + str(round(media_mismas_restr_n_iter,3)).rjust(15) + ' |' + str(round(media_mismas_restr_n_iter_ls,3)).rjust(15) + ' |' + str(round(media_mismas_restr_elapsed_time, 3)).rjust(15) + ' |' + str(round(media_mismas_restr_no_improv,3)).rjust(15) + ' ||\n'
            with open(nombre_archivo_resumen_mismas_restr, "a") as archivo:
    ...
    media_no_improv = (sum(list_no_improve)/len(list_no_improve)) * 100

    resumen_dataset = '||' + str(f"{data}").rjust(15) + ' |' + str(round(media_score,3)).rjust(15) + ' |' + str(round(media_n_iter,3)).rjust(15) + ' |' + str(round(media_n_iter_ls,3)).rjust(15) + ' |' + str(round(media_elapsed_time, 3)).rjust(15) + ' |' + str(round(media_no_improv,3)).rjust(15) + ' ||\n'
    with open(nombre_archivo_resumen_dataset, "a") as archivo:
